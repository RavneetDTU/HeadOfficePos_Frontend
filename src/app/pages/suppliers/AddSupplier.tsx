...
export function AddSupplier() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : "Failed to add supplier. Please check your data.");
    } finally {
      setIsSaving(false);
    }
  };
  ...
  return (
    <div className="p-4 bg-white min-h-screen">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500 mb-3">
        ...
        <span className="text-gray-900 font-medium">Add Supplier</span>
      </div>
      ...
      {success && (
        <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center gap-2 text-green-700 text-sm animate-pulse">
          ...
          Supplier added successfully! Redirecting to suppliers list...
        </div>
      )}
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-5">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-700 mb-1">Supplier Custom Field</label>
                  <input
                    type="text"
